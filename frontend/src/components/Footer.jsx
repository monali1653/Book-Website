      ...
      <div className="max-w-7xl mx-auto grid gap-10 sm:grid-cols-2 md:grid-cols-4">
        ...
        <div className="space-y-2">
          ...
          <ul className="space-y-1">
            ...
            <li>
              <Link to="/myprofile/wishlist" className="hover:text-orange-500">
                Wishlist
              </Link>
            </li>
            <li>
              <Link to="/myprofile/cart" className="hover:text-orange-500">
                Cart
              </Link>
            </li>
            <li>
              <Link to="/sold-items" className="hover:text-orange-500">
                Sold Items
              </Link>
            </li>
          </ul>
        ...
        <div className="space-y-2">
          ...
          <ul className="space-y-1">
            <li>
              <Link to="/myprofile" className="hover:text-orange-500">
                My Account
              </Link>
            </li>
            <li>
              <Link to="/myprofile/orders" className="hover:text-orange-500">
                Orders
              </Link>
            </li>
            <li>
        ...
        {/* Register Section */}
        <div className="space-y-2">
          <h3 className="font-gothic font-semibold text-lg">
