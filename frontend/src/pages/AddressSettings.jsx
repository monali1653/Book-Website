  ...
  return (
    <div className="flex flex-col md:flex-row min-h-screen">
      <div className="w-full md:w-1/4 p-6 bg-gray-50 border-r space-y-6">
        ...
        <div>
          ...
          <button
            ...
            className="font-parastoo ml-6 text-lg"
          >
            Personal Info
          </button>
          <br />
          <button
            ...
            className="ml-6 text-lg font-parastoo font-bold"
          >
            Manage Address
          </button>
        </div>
      ...
      <div className="flex-1 p-6">
        <h1 className="font-gothic text-2xl font-semibold mb-4">
          Account Settings
        </h1>
        <h2 className="font-gothic text-xl font-medium mb-2 text-green-600">
          Manage Addresses
        </h2>
        ...
        {addresses.map((addr, index) => (
          <div
            key={index}
            className="font-parastoo border p-4 mb-4 rounded-md bg-gray-50"
          >
        ...
        {!showForm && (
          ...
          >
            ...
            <span className="font-gothic text-green-600">
              ADD A NEW ADDRESS
            </span>
          </div>
        )}
          ...
          <div className="bg-green-50 p-6 rounded-md">
            <div className="font-parastoo grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                />
                {errors.locality && (
                  <p className="text-red-600 text-sm">{errors.locality}</p>
                )}
              </div>
              ...
              <div>
                ...
                />
                {errors.altPhone && (
                  <p className="text-red-600 text-sm">{errors.altPhone}</p>
                )}
              </div>
            </div>
            ...
            <div className="flex gap-4 mt-6">
              <button
                onClick={handleSave}
                className="font-gothic bg-green-600 text-white px-6 py-2 rounded hover:bg-green-700"
              >
                SAVE
              </button>
              <button
                onClick={handleCancel}
                className="font-gothic text-green-600 px-6 py-2 rounded hover:underline"
              >
                CANCEL
              </button>
            </div>
