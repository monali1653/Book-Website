    ...
    <div className="min-h-screen flex flex-col md:flex-row bg-[#f5f5f5]">
      ...
      <div className="md:w-1/2 w-full bg-white flex items-center justify-center p-6 relative">
        <div className="w-full max-w-md">
          <h2 className="font-gothic text-2xl font-bold text-gray-800 mb-2">
            Please create an account
          </h2>
          <p className="font-parastoo text-lg text-gray-600 mb-6">
            Give your credentials to register
          </p>

          <form className="space-y-4" onSubmit={handleRegister}>
            {["fullName", "phoneNo", "email", "username", "password"].map(
              (field, i) => (
                <div key={i} className="mb-4">
                  ...
                  {field === "phoneNo" && formData.phoneNo && (
                    <>
                      ...
                      {!/^[6-9]/.test(formData.phoneNo) &&
                        formData.phoneNo.length === 10 && (
                          <p className="text-red-500 text-sm mt-1">
                            Phone number must start with digits 6–9.
                          </p>
                        )}
                    </>
                  )}
            ...
            <div>
              <label className="font-parastoo block text-gray-700 mb-1 text-lg">
                Avatar (Optional)
              </label>
              {formData.avatar && (
                <img
        ...
        {showAvatarModal && (
          <div className="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50">
            <div className="bg-white p-6 rounded-lg shadow-lg max-w-md w-full relative">
              ...
              <h3 className="font-parastoo text-xl text-gray-800 mb-4">
                Choose Your Avatar
              </h3>
